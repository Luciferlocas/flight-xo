...
export const getAircraftName = (hop: FlightHop): string => {
    if (hop.aircraftTypeDisplayName && hop.aircraftTypeDisplayName.trim() !== "") {
...
const AIRLINE_LOGO_CONFIG = {
    base_url: "https://paytmtravel-images-akamai.paytm.com/flights/airlines+logo/",
    default_url: "https://paytm-travel-mum-akamai.paytm.com/travel_db/flights/airlines+logo/defaultcarrier.png"
};

export const getPaytmAirlineLogo = (airlineCode: string | undefined | null): string => {
